...
int main(int argc, char** argv)
{
  ...
  ros::ServiceClient arming_client =
      nh.serviceClient<swarm_ctrl_pkg::srvMultiArming>("multi_arming");
  ros::ServiceClient set_mode_client =
      nh.serviceClient<swarm_ctrl_pkg::srvMultiMode>("multi_mode");
  ros::ServiceClient set_home_client =
      nh.serviceClient<swarm_ctrl_pkg::srvMultiSetHome>("multi_set_home");
  ros::ServiceClient set_pos_client =
      nh.serviceClient<swarm_ctrl_pkg::srvMultiSetPosLocal>(
          "multi_set_pos_local");
  ros::ServiceClient set_vel_client =
